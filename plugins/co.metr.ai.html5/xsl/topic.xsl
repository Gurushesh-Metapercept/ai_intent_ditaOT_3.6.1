...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="plugin:co.metr.ai.html5:xsl/get-meta.xsl"/>
  <xsl:include href="plugin:co.metr.ai.html5:xsl/rel-links.xsl"/>
  ...
  <xsl:template name="spec-title">
    <xsl:if test="@spectitle"><div style="margin-top: 1em;"><xsl:if test="@ai-intent">
      <xsl:attribute name="ai-intent" select="@ai-intent"/>
    </xsl:if><strong><xsl:value-of select="@spectitle"/></strong></div></xsl:if>
  </xsl:template>
  <xsl:template name="spec-title-nospace">
    <xsl:if test="@spectitle"><div style="margin-bottom: 0;"><xsl:if test="@ai-intent">
      <xsl:attribute name="ai-intent" select="@ai-intent"/>
    </xsl:if><strong><xsl:value-of select="@spectitle"/></strong></div></xsl:if>
  </xsl:template>
...
<html>
  ...
  <xsl:template match="*" mode="addHeaderToHtmlBodyElement">
    ...
    <xsl:if test="exists($header-content)">
      <header xsl:use-attribute-sets="banner" style="margin-bottom:1rem;">
  ...
  <xsl:include href="plugin:co.metr.ai.html5:xsl/tables.xsl"/>
  <xsl:include href="plugin:co.metr.ai.html5:xsl/simpletable.xsl"/>
  ...
  <xsl:template match="*[contains(@class,' topic/shortdesc ')]" mode="gen-metadata">
    ...
    <meta name="description">
      <xsl:if test="@ai-intent">
        <xsl:attribute name="ai-intent" select="@ai-intent"/>
      </xsl:if><xsl:attribute name="content">
  ...
  <xsl:include href="plugin:co.metr.ai.html5:xsl/css-class.xsl"/>
  <xsl:include href="plugin:co.metr.ai.html5:xsl/functions.xsl"/>
